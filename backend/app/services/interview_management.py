...
class InterviewService:
    ...
    def _to_response(self, interview: Interview) -> InterviewResponse:
        ...
        return InterviewResponse(
            ...
            interview_score=getattr(interview, "interview_score", None),
            questions_json=getattr(interview, "questions_json", None),
            answers_json=getattr(interview, "answers_json", None),
            evaluation_json=getattr(interview, "evaluation_json", None),
